...
public class MoviInfoController {
	...
	public  MoviInfoController() 
	{
		movies = new ArrayList<Movie>();
		movies.add(new Movie(101 ,"Titanic" ,"Released in 1998"));
		movies.add(new Movie(102 ,"Avengers" ,"Released in 2000"));
		movies.add(new Movie(103 ,"The Shift" ,"Released in 2005"));
		movies.add(new Movie(104 ,"The peaceful Warrior" ,"Released in 1999"));
	}
